...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="LLM prompt sent alongside page images for OCR extraction",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "agrees",
                    models.BooleanField(
                        help_text="Whether the user agrees with this link"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="directories_content_0d4ce6_idx",
                    )
                ],
        ...
        migrations.AddIndex(
            model_name="page",
            index=models.Index(
                fields=["directory", "order"], name="directories_directo_2bf25f_idx"
            ),
        ),
    ]
