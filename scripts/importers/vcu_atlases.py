...
parser = argparse.ArgumentParser(
    description="Download Beers or Baist Atlas images from VCU and create index."
)
parser.add_argument(
    "--atlas",
    type=str,
    default="beers",
    help="Which atlas to download (beers or baist)",
)
...
for i in range(4, 25):
    ...
    if response.status_code == 200:
        ...
        item_id = re.findall(r"Plate Number</h2>\s*<p>(.*?)</p>", item_info.text)
